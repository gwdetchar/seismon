...
p_ts2 = [z_velocity];
y = file(fix(end/1.5):end,9);
z = thetas_z(1) + thetas_z(2) * p_ts2(:,1) + thetas_z(3) * p_ts2(:,2) + thetas_z(4) * p_ts2(:,3) + ...
    thetas_z(5) * p_ts2(:,4) + thetas_z(6) * p_ts2(:,5) + thetas_z(7) * p_ts2(:,6);
hh=1./(1+exp(-z));
