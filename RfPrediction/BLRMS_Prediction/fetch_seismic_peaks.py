...
#
#  Input Earthquake Event file (Ex: LLO.dat) must be added to ./masterlists/ 
#  With  the following column format: 
#	eventName, Magnitude, Latitude, Longitude, Depth, Distance, EQ time,
#	P, S, R_2, R_3.5, R_5
#   
#
#  USAGE:
#
#  Login to Caltech Cluster
#
#  Activate GWpy environment 
# . ~detchar/opt/gwpysoft/bin/activate
#
#  Execute
#  python fetch_seismic_peaks.py -IFO LLO -saveResult 1 -ID 109  
#
# Author: Nikil Mukund Menon (AEI, Hannover)
...
print("########################## SEISMON V2  ###############################")
print('  ')
print("IFO = {}\neventName = {}\nMagnitude = {}\nLatitude = {}\nLongitude = {}\nDepth = {}\nDistance = {}\nEQ time = {}\nP = {}\nS = {}\nR_2 = {}\nR_3.5 = {}\nR_5 = {}\n".format(IFO,EQ[0],EQ[1],EQ[2],EQ[3],EQ[4],EQ[5],EQ[6],EQ[7],EQ[8],EQ[9],EQ[10],EQ[11]))
print('---------------------------------------------------------')

tstart =  P-1200 #1185753618  #1162512017 #1185753618
tstop  = tstart + 7200
figName = './Plots/seismic_blrms_{}_{}_{}.png'.format(blrms_band,tstart,tstop)
fileName =  './Data/seismic_blrms_{}_{}_{}.txt'.format(blrms_band,tstart,tstop)
...
thresh = np.mean(x) + 1*np.std(x)

pks = detect_peaks(x, mph=thresh, mpd=2000,threshold=0, show=False)

Max_Amp = np.nan
Max_Amp_Loc = -1

# Limit to a smaller region around the predicted arrival time of R35 
if len(pks) > 0:
    try:
