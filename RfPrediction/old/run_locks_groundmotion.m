...
if strcmp(site,'LHO')
   channelx = 'H1_ISI-GND_STS_HAM2_X_DQ';
   channely = 'H1_ISI-GND_STS_HAM2_Y_DQ';
   channelz = 'H1_ISI-GND_STS_HAM2_Z_DQ';

   segfilename = 'data/segs_Locked_H_1126569617_1136649617.txt';
elseif strcmp(site,'LLO')
   channelx = 'L1_ISI-GND_STS_HAM2_X_DQ';
   channely = 'L1_ISI-GND_STS_HAM2_Y_DQ';
   channelz = 'L1_ISI-GND_STS_HAM2_Z_DQ';
...
save(['./plots/lockloss_groundmotion_' site '.mat'])
