...
class llo_catalogue(Base):
    ...
    channel = sa.Column(
        sa.String,
        nullable=False,
        comment='Seismometer Channel name')  

    FS = sa.Column(
            sa.Float,
            nullable=False,
            comment='Seismometer sampling frequency [Hz]')   
    ...
    eventTime_GPS = sa.Column(
            sa.Float,
            nullable=False,
            comment='eventTime_GPS')                                  
    ...
    mean_noise_level = sa.Column(
            sa.Float,
            nullable=False,
            comment='Mean Noise Level')    

    integrated_signal_um = sa.Column(
            sa.Float,
            nullable=False,
            comment='integrated_signal_um')     

    signal_duration = sa.Column(
            sa.Float,
            nullable=False,
            comment='Earthquake duration felt at the site [secs]')   

    integrated_signal_um_per_s = sa.Column(
            sa.Float,
            nullable=False,
            comment='integrated_signal_um_per_s') 

    peak_data_um = sa.Column(
            sa.Float,
            nullable=False,
            comment='peak_data_um') 
